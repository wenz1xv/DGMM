...
class TVAE(Model):
    ...
    def save(self, path, **kwargs):
        self.encoder.save(path+'_encoder.h5', **kwargs)
        self.decoder.save(path+'_decoder.h5', **kwargs)
    ...
    def compile(self, optimizer='none', *args, **kwargs):
        ...
        super(TVAE, self).compile(*args, **kwargs)
...
class TVAEsmi(Model):
    ...
    def compile(self, optimizer='none', *args, **kwargs):
        ...
        self.encoder.compile(optimizer=self.optimizer)
        self.decoder.compile(optimizer=self.optimizer)
        super(TVAEsmi, self).compile(*args, **kwargs)
